...
main()
{
    // Ensure the game mode is properly initialized
    ...
    // Set game mode specific dvars
    setdvar("ui_gametype", "infect");
    setdvar("ui_gametype_name", "Infection");
    ...
    // Ensure the game mode appears in the game modes list
    setdvar("ui_gametype", "infect");
    setdvar("ui_gametype_name", "Infection");
}
...
get_survivor_class_data()
{
    ...
    {
        level.infect_survivor_class_index = 7;
    }
